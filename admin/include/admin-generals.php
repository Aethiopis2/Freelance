...
/**
 * admin-generals.php 
 *  redefintion of general-functions.php but more or less tailored to admin
 *
 * Date created:
...
require_once($_SERVER['DOCUMENT_ROOT'] . '/xpress-media/config.php');
...
/* ============================================================================================|
 * Updates table info starting from a new connection; should conditions require it to do so
 * ============================================================================================*/
function Update_Info_Ajax($sql) {
    global $hn,$un, $pw, $db;
